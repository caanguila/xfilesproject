...
ALTER TABLE Files DROP CONSTRAINT FKFiles16097;
...
ALTER TABLE Files DROP CONSTRAINT FKFiles974192;
ALTER TABLE Files DROP CONSTRAINT FKFiles974193;
...
enc_type_def_id int8 NOT NULL, 
"key" varchar(500), 
PRIMARY KEY (user_id, enc_type_def_id));
...
PRIMARY KEY (Filesfile_id, Groupsgroup_id));
...
ALTER TABLE Files ADD CONSTRAINT FKFiles16097 FOREIGN KEY (created_by, enc_type_def_id) REFERENCES Password_Storage (user_id, enc_type_def_id);
