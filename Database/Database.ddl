...
DROP  TABLE Users_Passwords CASCADE;
DROP  TABLE Files CASCADE;
DROP  TABLE User_Files CASCADE;
DROP  TABLE User_Session CASCADE;
DROP  TABLE EncryptionFiles CASCADE;
DROP  TABLE Password_Storage CASCADE;
DROP  TABLE Files_Passwords CASCADE;
DROP  TABLE Logs CASCADE;
DROP  TABLE Action_types CASCADE;
DROP  TABLE Files_Groups CASCADE;
